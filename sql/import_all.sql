...
LOAD DATA INFILE '/tmp/INDI11Q2.TXT' REPLACE INTO TABLE aers.indi FIELDS TERMINATED BY '$' IGNORE 1 LINES;TRUNCATE TABLE aers.outc;
...
LOAD DATA INFILE '/tmp/OUTC11Q2.TXT' REPLACE INTO TABLE aers.outc FIELDS TERMINATED BY '$' IGNORE 1 LINES;TRUNCATE TABLE aers.reac;
...
LOAD DATA INFILE '/tmp/REAC11Q2.TXT' REPLACE INTO TABLE aers.reac FIELDS TERMINATED BY '$' IGNORE 1 LINES;TRUNCATE TABLE aers.ther;
...
LOAD DATA INFILE '/tmp/THER11Q2.TXT' REPLACE INTO TABLE aers.ther FIELDS TERMINATED BY '$' IGNORE 1 LINES;UPDATE aers.demo SET death_dt=NULL WHERE death_dt='0000-00-00';
