...
if __name__ == '__main__':
    ...
    DEFAULT = Namespace('http://annotation.data2semantics.org/resource/')
    ANNOTATION = Namespace('http://annotation.data2semantics.org/resource/annotation/')
    TARGET = Namespace('http://annotation.data2semantics.org/resource/target/')
    SELECTOR = Namespace('http://annotation.data2semantics.org/resource/selector/')
    LEVEL = Namespace('http://annotation.data2semantics.org/resource/level/')
    SUMMARY = Namespace('http://annotation.data2semantics.org/resource/summary/')
    REF = Namespace('http://annotation.data2semantics.org/resource/reference/')
    
    
    D2SA = Namespace('http://www.data2semantics/vocab/annotation/')
